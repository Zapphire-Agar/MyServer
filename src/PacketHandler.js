...
PacketHandler.prototype.handshake_onCompleted = function (protocol, key) {
    ...
    this.socket.sendPacket(new Packet.SetBorder(this.socket.playerTracker, this.gameServer.border, this.gameServer.config.serverGamemode, "The Best Server Of Agar.io By JoseFredoHD And Dante " + this.gameServer.version));
